...
CREATE TABLE "Love" (
    ...
    CONSTRAINT "Love_pkey" PRIMARY KEY ("userId","productId")
);
...
-- AddForeignKey
ALTER TABLE "Love" ADD CONSTRAINT "Love_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
